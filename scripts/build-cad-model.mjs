...
// (No artificial shrink here -- the board is kept at its true CAD size. The housing's black
// outer band now lifts fully out of frame during the electronics reveal instead, in LampModel.tsx.)
